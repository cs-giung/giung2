...
DATA_AUGMENTATION = {
    ...
    "STANDARD_TRAIN_TRANSFORM": torchvision.transforms.ToTensor(),
}


class MNIST(torchvision.datasets.VisionDataset):
    ...
    def __init__(
        ...
        if indices is None:
            indices = list(range(60000)) if split == "train" else list(range(10000))
